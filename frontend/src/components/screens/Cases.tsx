...
export default function Cases() {
  return (
    <div className="fade-up">
      <h1 className="text-[18px] font-extrabold mb-1">Cases</h1>
      <p className="text-sm text-[#4B6B63] mb-6">6 total · 2 urgent</p>
      <div className="bg-white border border-[#E5EDEB] rounded-[10px] p-6 text-center">
        ...
        <div className="mt-4 bg-[#F7FAFA] rounded-[8px] p-3 text-xs font-mono text-[#4B6B63] text-left">
          ...
          // GET /api/v1/cases — list records<br />
          // POST /api/v1/cases — create record<br />
          // PATCH /api/v1/cases/:id — update<br />
