...
export default function Wizard() {
  return (
    <div className="fade-up">
      <h1 className="text-[18px] font-extrabold mb-1">New Inspection</h1>
      <p className="text-sm text-[#4B6B63] mb-6">5-step inspection wizard</p>
      <div className="bg-white border border-[#E5EDEB] rounded-[10px] p-6 text-center">
        ...
        <div className="mt-4 bg-[#F7FAFA] rounded-[8px] p-3 text-xs font-mono text-[#4B6B63] text-left">
          ...
          // GET /api/v1/wizard — list records<br />
          // POST /api/v1/wizard — create record<br />
          // PATCH /api/v1/wizard/:id — update<br />
