...
export default function PhotoAI() {
  return (
    <div className="fade-up">
      <h1 className="text-[18px] font-extrabold mb-1">Photo AI</h1>
      <p className="text-sm text-[#4B6B63] mb-6">Claude analyses vehicle photos — click any zone</p>
      <div className="bg-white border border-[#E5EDEB] rounded-[10px] p-6 text-center">
        ...
        <div className="mt-4 bg-[#F7FAFA] rounded-[8px] p-3 text-xs font-mono text-[#4B6B63] text-left">
          ...
          // GET /api/v1/photoai — list records<br />
          // POST /api/v1/photoai — create record<br />
          // PATCH /api/v1/photoai/:id — update<br />
